...
def make_fake_block_coords_artifacts():
    tiles =  ["{},{}".format(i,j) for i in range(3) for j in range(4)]
    return [TextArtifact(t) for t in tiles]
...
##############LEFT############
    ...
    n_Lfind2 = builder.node(action="find",notes="Go to coords2, find remaining tiles to complete grid")
...
##############RIGHT############
    ...
    cw = CrosswordPuzzle(
        ...
        across={1: "Comes after age", 4: "Touch it", 5: "You're running out of it", 6: "When you have an itch"},
        down={},
...
##############RE-MERGE############
    ...
    n_grid_merge = builder.node(action="combine",notes="Combine grid and grille for secret message")
